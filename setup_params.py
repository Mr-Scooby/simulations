...
class PhysicalRegime: 
    ...
    # Motional dephasing parameter: Whether thermal motion changes optical phase.
    # k * v_th * tau
    mot_dephase : float = 1 
...
class PhysicalParams:
    ...
    # Motion / time
    v_front: float = 1.0
    v_thermal: float = field(init=False)
    ...
    def __post_init__(self):
        ...
        self.L_perp = self.L_parallel   # isotropic default; change if you want cigar/pancake clouds
        ...
        # with t_char taken from pulse transit through the cloud
        self.t_char = r.pulse_transit * self.L_parallel / self.v_front
        self.v_thermal = r.mot_dephase / (self.k0 * self.t_char)
